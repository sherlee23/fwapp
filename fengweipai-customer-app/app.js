...
const products = [
  ...
  { id: 28, name: '黑猪肉香菜水饺 ( 1 包 12只）', price: 28, image: 'IMG_4051.jpeg', category: '水饺系列', emoji: '🥟', "status": "available"},
  { id: 29, name: '黑猪肉紫苏水饺 ( 1 包 12只）', price: 28, image: 'IMG_4050.jpeg', category: '水饺系列', emoji: '🥟', "status": "available"},
  { id: 30, name: '原味黑猪肉小笼包 ( 1 包 8只）', price: 25, image: 'IMG_4053.jpeg', category: '小笼包系列', emoji: '🥟', "status": "available"},
  { id: 31, name: '川香火锅小笼包 ( 1 包 8只）', price: 25, image: 'IMG_4052.jpeg', category: '小笼包系列', emoji: '🥟', "status": "available"},
  { id: 32, name: '鲜花蒸饺墨鱼馅 ( 1 盒 10只）', price: 88, image: 'IMG_4054.jpeg', category: '蒸饺系列', emoji: '🥟', "status": "available"},
  { id: 33, name: '鲜花蒸饺鲅鱼馅 ( 1 盒 10只）', price: 88, image: 'IMG_4055.jpeg', category: '蒸饺系列', emoji: '🥟', "status": "available"},
  { id: 34, name: '酥皮烤肠', price: 98, image: 'IMG_5636.jpeg', category: '酥皮烤肠系列', emoji: '🌭', "status": "available"},
];
